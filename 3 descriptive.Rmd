...
pacman::p_load(tidyverse,data.table,dplyr,knitr,tinytex,corrplot,stringr,summarytable,makecell,haven,
               Hmisc,showtext,stats,pollster,sjPlot,psych,lavaan, viridis, texreg, kableExtra,writexl,
...
p_cb04_nar1 <- ggplot(sum_cb04_nar1, aes(x = fct_relevel(sentence, rev(levels(sentence))), 
  ...
  labs(
    title = "Degree of Agreement (Stimulus 1, All Treatment Units)",
    y = "",
    x = ""
  ) +
...
p_cb04_nar2 <- ggplot(sum_cb04_nar2, aes(x = fct_relevel(sentence, rev(levels(sentence))), 
  ...
  labs(
    title = "Degree of Agreement (Stimulus 2, All Treatment Units)",
    y = "",
    x = ""
  ) +
  geom_hline(yintercept = 0, linetype = "dashed", color = plotplainblind[1]) +
...
p_cb04_nar3 <- ggplot(sum_cb04_nar3, aes(x = fct_relevel(sentence, rev(levels(sentence))),
  ...
  labs(
    title = "Degree of Agreement (Stimulus 3, All Treatment Units)",
    y = "",
    x = ""
  ) +
  geom_hline(yintercept = 0, linetype = "dashed", color = plotplainblind[1]) +
...
p_cb04_nar4 <- ggplot(sum_cb04_nar5, aes(x = fct_relevel(sentence, rev(levels(sentence))), 
  ...
  labs(
    title = "Degree of Agreement (Stimulus 4, All Treatment Units)",
    y = "",
    x = ""
  ) +
  geom_hline(yintercept = 0, linetype = "dashed", color = plotplainblind[1]) +
...
heatmap_emo <- ggplot(sum_emotion_all, aes(x = factor(stimulus), 
  ...
  labs(title = "Emotions evoked for all treatment units (%)",
       #subtitle = subtitle,
       x = "Stimulus",
       y = "",
       fill = "Percentage") +
