...
``` {r prep_stimtime_correct_treatment}
...
ggsave(filename = file.path(fig, "paper_meandiff_readtime_correct.png"),
...
ggsave(filename = file.path(fig, "paper_heatmap_emo_all.png"),
       plot = heatmap_emo,
       #width = 8,
       #height = 4,
       dpi = 100)
...
ggsave(filename = file.path(fig, "paper_heatmap_emo_sub.png"),
